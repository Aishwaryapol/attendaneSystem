...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($attendanceData) {
        try {
            ...
            $_SESSION['message'] = "Attendance has been successfully recorded for all entries.";
...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <p style="font:80px; font-weight:400; color:blue; text-align:center; padding-top:2px;">Please select a course, unit, and venue before launching facial recognition.</p>
